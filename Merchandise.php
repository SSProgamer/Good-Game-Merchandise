                    ...
                    <div class="merchaimagebig">
                        ...
                        while ($row = $ret->fetchArray(SQLITE3_ASSOC)) {
                            if ($row['ID'] == "1") {
                                ...
                                echo "</div>";
                                echo "<div class ='col-lg-6 m-5 p-5'>";
                                ...
                                echo    "<button type='button' class='custombigbut' onclick='purchasePopUp()'>Purchase</button>";
                                echo "<button type='button' class='customsmallbut' onclick=''>Add to wishlist</button></div>";
